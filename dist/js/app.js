...
viewContainerEl.addEventListener('click', function (evt) {
  ...
  if (tab === 'flights') {
    ...
    var flightArrivalInfoEl = _jquery2.default.getJSON("http://apis.is/flight?language=en&type=arrivals").then(function (serverRes) {
      var articleArrivalList = serverRes.results;
      var flightsHtmlString = '\n  <div class=\'flights-page container\'>\n    <h2>Flights</h2>\n    <div class=\'flight-arrival\'>\n    <div class=\'arrivals\'>\n      <h3>Arrivals</h3>';

      var flightsArrivalHtmlString = '\n      <table>\n        <thead>\n          <tr>\n            <th>Date</th>\n            <th>Arrival Time</th>\n            <th>Origin</th>\n            <th>Airline</th>\n          </tr>\n        </thead>\n        </table>';
      ...
      var flightDepartureInfoEl = _jquery2.default.getJSON("http://apis.is/flight?language=en&type=departures").then(function (serverRes) {
        var articleDepartureList = serverRes.results;
        var flightsDepartureHtmlString = '\n        <div class=\'departures\'>\n          <h3>Departures</h3>\n        <table>\n          <thead>\n            <tr>\n              <th>Date</th>\n              <th>Arrival Time</th>\n              <th>Origin</th>\n              <th>Airline</th>\n            </tr>\n          </thead>\n          </table>';
  ...
  if (tab === 'carpools') {
    ...
    var carpoolInfoEl = _jquery2.default.getJSON("http://apis.is/rides/samferda-drivers/").then(function (serverRes) {
